...
export const WEEKS_DATA: WeekData[] = [
  {
    weekNumber: 1,
    title: 'מיפוי חרדה + שגרה בטוחה',
    subtitle: 'יצירת שגרה בטוחה, מיפוי חרדה ובסיס',
    phase: 'א׳ — יציבות',
    exercises: [
      { category: 'breathing', title: 'נשיפה ארוכה', duration: '5–8 דק׳', description: 'ישיבה נוחה, שאיפה 4 שנ׳ → נשיפה 6 שנ׳. מיקרו-השהיה בסוף כל נשיפה. 6–8 סבבים.', icon: '🌬️' },
      { category: 'movement', title: 'הליכה קלה', duration: '10–20 דק׳', description: 'הליכה בקצב נוח, תשומת לב לנשימה ולצעדים.', icon: '🚶' },
      { category: 'mind', title: 'קרקוע', duration: '5 דק׳', description: 'תרגיל 5-4-3-2-1: שימו לב ל-5 דברים שרואים, 4 שומעים, 3 נוגעים, 2 מריחים, 1 טועמים.', icon: '🧘' },
      { category: 'creation', title: 'דף פריקה', duration: '10 דק׳', description: 'כתיבה חופשית — שפכו הכל על הדף בלי סינון או שיפוט.', icon: '✍️' },
    ],
    exposure: 'לבחור אי-ודאות קטנה אחת — למשל, לא לבדוק הודעות למשך 10 דקות.',
  },
  {
    weekNumber: 2,
    title: 'זיהוי התנהגויות ביטחון',
    subtitle: 'זיהוי והפחתה מינימלית של התנהגויות ביטחון',
    phase: 'א׳ — יציבות',
    exercises: [
      { category: 'breathing', title: 'PMR קצר', duration: '8–10 דק׳', description: 'כווצו 5 שנ׳ → שחררו 10 שנ׳ בכל קבוצת שרירים: כפות ידיים → כתפיים → פנים → בטן → ירכיים → שוקיים.', icon: '🌬️' },
      { category: 'movement', title: 'תנועה', duration: '15–25 דק׳', description: 'פעילות גופנית מתונה — הליכה, מתיחות, או תנועה חופשית.', icon: '🏃' },
      { category: 'mind', title: 'קשב לנשימה', duration: '7–10 דק׳', description: 'שבו בנוחות ושימו לב לנשימה — בלי לשנות אותה. כשהמחשבה נודדת, חזרו בעדינות.', icon: '🧘' },
      { category: 'creation', title: 'כתיבה', duration: '10–12 דק׳', description: 'כתיבה אקספרסיבית: 2 דק׳ "מה מפחיד אותי?", 8 דק׳ עיבוד, 2 דק׳ פעולה קטנה.', icon: '✍️' },
    ],
    exposure: 'להפחית התנהגות ביטחון אחת ב-10% — למשל, פחות בדיקת מייל.',
    tip: 'מדידה מינימלית בלבד! מדד שבועי אחד (GAD-7) וציון יומי 0–10. ניטור יתר מעצים חרדה.',
  },
  {
    weekNumber: 3,
