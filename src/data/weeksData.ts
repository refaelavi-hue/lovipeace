...
export const WEEKS_DATA: WeekData[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { category: 'creation', title: 'כתיבה: מה אני מנסה למנוע?', duration: '10 דק׳', description: 'כתבו על רגע שבו חיפשתם ביטחון. מה חששתם שיקרה? מה עשיתם כדי להרגיש בשליטה? כתבו בלי ביקורת ובלי לנסות לפתור.', icon: '✍️' },
    ],
